...
--
-- Host: 127.0.0.1
-- Generation Time: May 16, 2022 at 12:23 AM
...
(5, 8, 1, 'ได้ผ่านการอบรมออนไลน์ test 2', '2022-05-15 17:58:34', '2022-05-15 18:30:34');
...
(7, 1, 'HM8UtK4qUi.png', 0, '2022-05-15 18:14:11', '2022-05-15 18:14:11');
...
(8, 1, 6, 'test2', '5JLQyBtBFQ.png', 'https://www.youtube.com/embed/kmiAUPwp6-E', 'test', 1, 5, 'test', 'test', 0, 1, 80, '2022-04-06 18:44:48', '2022-05-15 04:42:02');
...
(1, 'Computer', '2022-03-18 13:54:46', '2022-05-10 04:13:20'),
...
(6, 'test', '2022-05-14 04:53:30', '2022-05-14 04:53:30');
...
(5, 8, 'ทดสอบ', 2, '2022-04-07 07:19:47', '2022-05-15 09:21:16'),
(7, 8, 'การสร้างเงื่อนไข', 1, '2022-04-07 07:19:59', '2022-05-15 09:21:13'),
(12, 6, '22', 1, '2022-05-15 10:24:14', '2022-05-15 10:24:14');
...
(37, 7, 8, '_', '1652610138ปัทมาภรณ์.ขุนทอง-1.docx', '2022-05-15 10:22:18', '2022-05-15 10:22:18'),
(43, 12, 6, '1', '16526105146302041520210.pdf', '2022-05-15 10:28:26', '2022-05-15 10:28:34');
...
CREATE TABLE `lesson_link` (
  ...
  `lessons_id` bigint(20) UNSIGNED NOT NULL,
  `id_course` bigint(20) UNSIGNED NOT NULL,
  `lesson_link_name` varchar(255) NOT NULL,
  `lesson_link_path` varchar(255) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `lesson_link` (`id`, `lessons_id`, `id_course`, `lesson_link_name`, `lesson_link_path`, `created_at`, `updated_at`) VALUES
(1, 7, 8, 'test', 'https://youtu.be/PAdj66BAX8A?list=RDt_vKiT0XtSA', '2022-05-15 09:47:51', '2022-05-15 09:47:51');
...
('dddssaasasa@dddd.ddd', '$2y$10$51/jt8q/C53do4Xiq3C4Du4XW1x33sHdCvheEvpYlJyfv5n.R.b6S', '2022-05-15 22:13:21');
...
(45, 8, 1, 0, 0, 0, 0, '2022-05-15 21:10:42', '2022-05-15 21:10:42');
...
(1, 0, 'Eddy', 'Suttipongs', '2', '094019048', 'admin@admin.com', NULL, '$2y$10$SZXlRmy1MM0ubCjqDRkrX.LCo9MG7mhtTZgx3tPhilz/NWEG47bkm', 'ZJAzj5HqTw.jpg', NULL, '2022-02-24 15:12:09', '2022-05-14 15:00:40'),
...
(79, 2, 'eddy', 'galelo', '1', '0856565656', 'eee@eee.eee', NULL, '$2y$10$/JT2IDwUVbuh7cW8jK24eOGVqw1VwZ0gvlXXinCFm8u9vSQQyCYjS', 'nopic.jpg', NULL, '2022-05-15 21:48:59', '2022-05-15 21:50:02');
...
ALTER TABLE `lesson_link`
  ADD PRIMARY KEY (`id`),
  ADD KEY `lessons_link_lessons_id_FK` (`lessons_id`),
  ADD KEY `lessons_link_id_course_FK` (`id_course`);
...
--
-- Constraints for table `lesson_link`
--
ALTER TABLE `lesson_link`
  ADD CONSTRAINT `lesson_link_ibfk_1` FOREIGN KEY (`lessons_id`) REFERENCES `lessons` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `lesson_link_ibfk_2` FOREIGN KEY (`id_course`) REFERENCES `courses` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
