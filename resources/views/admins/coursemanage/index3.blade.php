                        ...
                        <table class="table table-bordered table-striped text-center" id="example1">
                            ...
                            @foreach ($courses as $course)
                                ...
                                <tr>
                                    ...
                                    <td><a class="btn btn-warning" href="Register_coursesManage/<?=$course->id?>/edit" role="button"><i class="fas fa-edit"></i> จัดการผู้ลงทะเบียนคอร์ส</a></td>
