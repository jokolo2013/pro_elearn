                    ...
                    <div class="row">
                        <div class="col-12">
                            <button type="button" class="btn btn-warning mt-3" data-toggle="modal"
                                data-target="#creatlessons"><i class="fas fa-plus"></i> สร้างบทเรียน</button><br>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($lessons as $les)
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a name="" id="" class="btn btn-dark" href="{{url('/lessonsfilevideo/'.$les->id.'/edit')}}" role="button"><i
                                                        class="fas fa-edit"></i> จัดการเนื้อหาในบทเรียน</a></td>
                                                    <td>
