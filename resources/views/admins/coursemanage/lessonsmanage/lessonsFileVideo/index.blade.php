                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a
                                href="{{ url('lessonsmanage/' . $courseName->id . '/edit') }}">{{ $courseName->course_name }}</a>
                        </li>
                        ...
                        <div class="col-12">
                                ...
                                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body text-left">
                                            ...
                                            <input type="hidden" id="Video_id_course" name="Video_id_course"
                                                value="{{ $courseName->id }}">
                                            <input type="hidden" id="Video_lessons_id" name="Video_lessons_id"
                                                value="{{ $lessonsName->id }}">
                                        </div>
                            ...
                            <div class="card mt-3">
                                <div class="card-header">
                                    <h3 class="card-title">แสดงข้อมูลวิดีโอในบทเรียนจำนวน {{ $lessonsVideo->count() }}
                                        วิดีโอ
                                    </h3>
                                </div>
                                <!-- /.card-header -->
                                            ...
                                            @foreach ($lessonsVideo as $lesVideo)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="modal fade" id="editlessonVideo<?= $i ?>"
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body text-left">
                                                                        ...
                                                                        <input type="hidden" id="Video_Type"
                                                                            name="Video_Type" value="Video_Type">
                                                                        <input type="hidden" id="Video_id_course"
                                                                            name="Video_id_course"
                                                                            value="{{ $courseName->id }}">
                                                                        <input type="hidden" id="Video_lessons_id"
                                                                            name="Video_lessons_id"
                                                                            value="{{ $lessonsName->id }}">
                                                                    </div>
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="btn btn-secondary"
                            ...
                            <hr>
                            <button type="button" class="btn btn-info " data-toggle="modal" data-target="#lessonsVideo"><i
                                    class="fas fa-plus"></i> เพิ่มไฟล์ในบทเรียน</button><br>
                            <div class="modal fade" id="lessonsVideo" tabindex="-1" role="dialog"
                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">เพิ่มไฟล์ในบทเรียน
                                            </h5>
                                            <button type="button" class="close" data-dismiss="modal"
                                                aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                        ...
                                        <div class="modal-body text-left">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <?= Form::text('lesson_files_name', null, ['class' => 'form-control', 'placeholder' => 'ชื่อไฟล์' , 'required']) ?>
                                            </div>
                                            <div class="form-group">
                                                <?= Form::label('lesson_files_path', 'อัพโหลดไฟล์') ?>
                                                <?= Form::file('lesson_files_path', null, ['class' => 'form-control' , 'required']) ?>
                                            </div>
                                            <input type="hidden" id="File_Type" name="File_Type" value="File_Type">
                                            <input type="hidden" id="File_id_course" name="File_id_course"
                                                value="{{ $courseName->id }}">
                                            <input type="hidden" id="File_lessons_id" name="File_lessons_id"
                                                value="{{ $lessonsName->id }}">
                            ...
                            <div class="card mt-3">
                                <div class="card-header">
                                    <h3 class="card-title">แสดงข้อมูลไฟล์ในบทเรียนจำนวน {{ $lessonsFile->count() }}
                                        ไฟล์
                                    </h3>
                                </div>
                                <!-- /.card-header -->
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($lessonsFile as $lesFile)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ url('/storage/' . $courseName->course_name . '/' . $lesFile->lesson_files_path) }}"
                                                            target="_blank">{{ $lesFile->lesson_files_path }}</a>
                                                    </td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="modal fade" id="editlessonFile<?= $i ?>"
                                                            tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                                                            aria-hidden="true">
                                                            <div class="modal-dialog modal-lg modal-dialog-centered"
                                                                role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body text-left">
                                                                        ...
                                                                        <input type="hidden" id="File_id_course"
                                                                            name="File_id_course"
                                                                            value="{{ $courseName->id }}">
                                                                        <input type="hidden" id="File_lessons_id"
                                                                            name="File_lessons_id"
                                                                            value="{{ $lessonsName->id }}">
                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <input type="hidden" id="delete_File"
                                                                            name="delete_File" value="delete_File">
                                                                            <input type="hidden" id="File_lessons_id"
                                                                            name="File_lessons_id"
                                                                            value="{{ $lessonsName->id }}">
                                                                        <input type="hidden" id="Course_name"
                            ...
                            <button type="button" class="btn btn-warning " data-toggle="modal"
                                data-target="#lessonsLink"><i class="fas fa-plus"></i> เพิ่มลิ้งในบทเรียน</button><br>
                            <div class="modal fade" id="lessonsLink" tabindex="-1" role="dialog"
                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">เพิ่มลิ้งในบทเรียน
                                            </h5>
                                            <button type="button" class="close" data-dismiss="modal"
                                                aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                        ...
                                        <div class="modal-body text-left">
                                            <?= Form::open(['url' => 'lessonsfilevideo/', 'files' => true]) ?>
                                            <div class="form-group">
                                                <?= Form::label('lesson_link_name', 'ชื่อลิ้งค์') ?>
                                                <?= Form::text('lesson_link_name', null, ['class' => 'form-control', 'placeholder' => 'ชื่อลิ้งค์', 'required']) ?>
                                            </div>
                                            <div class="form-group">
                                                <?= Form::label('lesson_link_path', 'ลิ้ง') ?>
                                                <?= Form::text('lesson_link_path', null, ['class' => 'form-control', 'placeholder' => 'ลิ้งค์', 'required']) ?>
                                            </div>
                                            <input type="hidden" id="Link_Type" name="Link_Type" value="Link_Type">
                                            <input type="hidden" id="Link_id_course" name="Link_id_course"
                                                value="{{ $courseName->id }}">
                                            <input type="hidden" id="Link_lessons_id" name="Link_lessons_id"
                                                value="{{ $lessonsName->id }}">
                                            <input type="hidden" id="Course_name" name="Course_name"
                                                value="{{ $courseName->course_name }}">
                                        </div>
                            ...
                            <div class="card mt-3">
                                ...
                                <div class="card-body">
                                    <table id="example3" class="table table-bordered table-striped text-center">
                                        ...
                                        <tbody>
                                            <?php $i = 0; ?>
                                            @foreach ($lesssonsLink as $lesLink)
                                                <?php $i++; ?>
                                                <tr>
                                                    <td><?php echo $i; ?></td>
                                                    <td>{{ $lesLink->lesson_link_name }}</td>
                                                    <td>
                                                        <a href="{{ $lesLink->lesson_link_path }}" target="_blank"> {{ $lesLink->lesson_link_path }} </a>
                                                    </td>

                                                    <td>
                                                        <button type="button" class="btn btn-secondary" data-toggle="modal"
                                                            data-target="#editlessonLink<?= $i ?>"><i
                                                                class="fas fa-edit"></i> แก้ไขลิ้งค์</button>
                                                        <div class="modal fade" id="editlessonLink<?= $i ?>"
                                                            tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                                                            aria-hidden="true">
                                                            <div class="modal-dialog modal-lg modal-dialog-centered"
                                                                role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body text-left">
                                                                        <?= Form::model($lesLink, ['url' => 'lessonsfilevideo/' . $lesLink->id, 'method' => 'put', 'files' => true]) ?>
                                                                        <div class="form-group">
                                                                            <?= Form::label('lesson_link_name', 'ชื่อลิ้งค์') ?>
                                                                            <?= Form::text('lesson_link_name', null, ['class' => 'form-control', 'placeholder' => 'ชื่อลิ้งค์', 'required']) ?>
                                                                        </div>
                                                                        ...
                                                                        <input type="hidden" id="Link_Type" name="Link_Type"
                                                                            value="Link_Type">
                                                                        <input type="hidden" id="Link_id_course"
                                                                            name="Link_id_course"
                                                                            value="{{ $courseName->id }}">
                                                                        <input type="hidden" id="Link_lessons_id"
                                                                            name="Link_lessons_id"
                                                                            value="{{ $lessonsName->id }}">
                                                                        <input type="hidden" id="Course_name"
                                                                            name="Course_name"
                                                                            value="{{ $courseName->course_name }}">
                                                    ...
                                                    <td>
                                                        <!-- Button trigger modal -->
                                                        <button type="button" class="btn btn-danger" data-toggle="modal"
                                                            data-target="#deleteLink<?= $i ?>">
                                                            ลบ
                                                        </button>
                                                        <!-- Modal -->
                                                        <div class="modal fade" id="deleteLink<?= $i ?>" tabindex="-1"
                                                            role="dialog" aria-labelledby="exampleModalLabel"
                                                            aria-hidden="true">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ต้องการลบลิ้งค์ <i class="fas fa-arrow-right"></i>
                                                                        {{ $lesLink->lesson_link_name }}
                                                                    </div>
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="btn btn-secondary"
                                                                            data-dismiss="modal">ยกเลิก</button>
                                                                        <?= Form::open(['url' => 'lessonsfilevideo/' . $lesLink->id, 'method' => 'delete']) ?>
                                                                            <input type="hidden" id="delete_Link"
                                                                            name="delete_Link" value="delete_Link">
                                                                            <input type="hidden" id="Link_lessons_id"
                                                                            name="Link_lessons_id"
                                                                            value="{{ $lessonsName->id }}">
                                                                        <input type="hidden" id="Course_name"
