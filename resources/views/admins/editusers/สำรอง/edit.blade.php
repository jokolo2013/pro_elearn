            ...
            <div class="col-lg-8 col-log-offset-1">
                <div class="card mt-3">
                    <div class="card-header h3">
                        แก้ไขข้อมูลสมาชิก {{ $users->Fname }} {{ $users->Lname }}
                    </div>

                    <div class="card-body">
                        <?= Form::model($users, ['url' => 'editusers/' . $users->id, 'method' => 'put', 'files' => true]) ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 mt-2">
                                <input type="radio" id="Gender_1" name="Gender" value="1" <?= $se1 ?>>
                                <label for="html">ชาย</label>
                                <input type="radio" id="Gender_2" name="Gender" value="2" <?= $se2 ?>>
                                <label for="html">หญิง</label>
                                <input type="radio" id="Gender_3" name="Gender" value="3" <?= $se3 ?>>
                        ...
                        <div class="form-group">
                            ...
                            <?= Form::text('tel', null, ['class' => 'form-control', 'placeholder' => 'เบอร์โทรศัพท์']) ?>
                        </div>

                        <div class="form-group">
                            <?= Form::label('email', 'อีเมล') ?>
                            <?= Form::text('email', null, ['class' => 'form-control', 'placeholder' => 'อีเมล']) ?>
                        </div>
                        ...
                        <div>
                            <a href="{{ asset('images/' . $users->pic_profile) }}" data-lity>
                                <img src="{{ asset('images/resize/' . $users->pic_profile) }}" style="width:100px">
                            </a>
                        </div>
